...
| 2026-09-04 | 478f3e8 | DXF tek okuma + triage heavy bayrağı + GT tier sütunu | 0.901 | 0.888 | 0.951 | 0.006 | 0.904 | 0.802 | 7 / 53 | GT-7 birebir aynı (13 dosyalık --only koşusu, taze); AVİDA_PLAN 547 s → 63 s (12 readfile → 1); heavy: ≥250k entity ya da ≥200k blok entity, heavy-timeout 900 s |
