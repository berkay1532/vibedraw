...
class Floor:
    ...
    # Kaynak bilgisi (walls/windows ile hizalı): pair+layer|pair ; layer|block_keyword|block_geometry|thin_lines
    wall_sources: list = field(default_factory=list)
    window_sources: list = field(default_factory=list)
